...
lista_aluno = []
''' Criando listas vazias para guardar nomes'''

def registrar_aluno ():
    # Pegando o nome que o aluno deixou na caixa
    nome = entrada_nome.get()
    # verificar se o usuario não deixou a caixa vazia
    if nome != "":
        lista_alunos.append(nome) # add nome na lista

        texto_exibicao = "\n".join(lista_aluno)

        # A tualizando o rotulo na tela com lista nova
        rotulo.lista.configure(text=f" Alunos Presente: \n {texto_exibicao}")
